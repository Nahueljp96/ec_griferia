...
@section('breadcrumb')
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="/home">Nuevo</a></li>
...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="#" class="fa fa-refresh" aria-hidden="true" onclick='windocategoriaw.location.replace("/admin/clientes");'><span>Recargar</span></a></li>
</ol>
@endsection
@section('contenido')
<?php
...
<script>
	$(document).ready( function () {
	    ...
	    "ajax": "{{ route('categoria.cargarGrilla') }}" //atributo que busca los datos para la grilla.
	});
} );   
</script>
@endsection